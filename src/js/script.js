window.addEventListener("DOMContentLoaded", function () {
  ...
  video.addEventListener("click", function () {
    ...
    video.insertAdjacentHTML(
      "afterbegin",
      '<iframe class="videoPreview" src="https://www.youtube.com/embed/pmrIlYBWP20?si=fEDOS5Ct8-rmn2I9&autoplay=1&rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
    );
  ...
  $(".show-all").click(function () {
    ...
    var buttonText = $(".all_icons").hasClass("d-none")
      ? "Показати всі..."
      : "Показати менше";
  ...
  function addEventListenersAndValidate(inputs, form, buttons, eventType) {
    ...
    $("#phone-participant, #phone-partner, #phone-mentor").on(
      "mouseenter",
      function () {
  ...
  addEventListenersAndValidate(
    formInputsParticipant,
    formParticipant,
    formButtons,
    "submit"
  );
